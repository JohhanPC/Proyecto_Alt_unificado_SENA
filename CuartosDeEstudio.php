...
<div class="nav-bar">
  ...
  <div class="grid-container">
      <?php
          ...
          $mostrarCuartosDeEstudio = new mostrarArticulos;
          $mostrarCuartosDeEstudio->datosDB('localhost', 'root','','DataBaseProyectoAlterno', 'cuartos_estudios');
          $mostrarCuartosDeEstudio->mostrarDatos();
      ?>
  </div>        
